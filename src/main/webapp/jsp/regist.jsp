...
<head>
    ...
    <script>
        ...
        function change() {
            var imgs = $("#checkImage");
            imgs.attr("src","${pageContext.request.contextPath}/checkImg.action?time="+new Date().getTime());
        }
    </script>
</head>
<body>
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <input type="text" id="username" name="username" class="text" maxlength="20" onblur="checkUsername()"><span id="usernames"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off"><span id="passwords"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="password" id="repassword" name="repassword" class="text" maxlength="20" autocomplete="off"><span id="repasswords"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="email" name="email" class="text" maxlength="200"><span id="emails"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="name" name="name" class="text" maxlength="200"><span id="names"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="phone" name="phone" class="text" ><span id="phones"></span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="addr" name="addr" class="text" maxlength="200"><span id="addrs"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
										<span class="fieldSet">
                                            ...
                                            <img id="checkImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change();" title="点击更换验证码">
										    <span id="code"></span>
                                        </span>
                            </td>
                        </tr>
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;">
    <iframe style="width: 190px; height: 191px;" src="" frameborder="0" border="0" scrolling="no"></iframe>
</div>
</body>
</html>